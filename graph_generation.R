...
graph.data <- fread("C:/Users/alockhart/Desktop/Toronto Survey/Graphs/Graphs_spreadsheet.csv")
...
figure_1_data <- fread("C:/Users/alockhart/Desktop/Toronto Survey/Graphs/Figure_1.csv")
figure.1 <- plot.column.dais(figure_1_data, stat, year, order.bar="ascending", group.by=description, label=FALSE,
...
#FIX
figure_3_data <- fread("C:/Users/alockhart/Desktop/Toronto Survey/Graphs/Figure_3.csv")
...
#figure.3 <- plot.column.dais(figure_3_data, stat, year, order.bar="ascending", group.by=description, label=TRUE,
...
#                             export = TRUE,
#                             export.name = "F3",
#                             colours=c("#eb0071", "#ec3479", "#ed4c82", "#ed608b",
#                                       "#ed7194", "#ed819d", "#ec8fa6", "#ea9eaf",
#                                       "#e8acb9" ,"#e5bac2" ,"#e1c7cc"))
...
figure_4_data <- fread("C:/Users/alockhart/Desktop/Toronto Survey/Graphs/Figure_4.csv")
...
figure_5_data <- fread("C:/Users/alockhart/Desktop/Toronto Survey/Graphs/Figure_5.csv")
...
figure_6_data <- fread("C:/Users/alockhart/Desktop/Toronto Survey/Graphs/Figure_6.csv")
...
figure.6 <- plot.column.dais(figure_6_data, stat, year, order.bar="descending", group.by=description, label=FALSE,
...
figure_7_data <- fread("C:/Users/alockhart/Desktop/Toronto Survey/Graphs/Figure_7.csv")
...
figure.7 <- plot.column.dais(figure_7_data, stat, year, group.by=description, label=FALSE,
...
figure_8_data <- fread("C:/Users/alockhart/Desktop/Toronto Survey/Graphs/Figure_8.csv")
...
figure_11_data <- fread("C:/Users/alockhart/Desktop/Toronto Survey/Graphs/Figure_11.csv")
...
figure_12_data <- fread("C:/Users/alockhart/Desktop/Toronto Survey/Graphs/Figure_12.csv")
...
figure_14_data <- fread("C:/Users/alockhart/Desktop/Toronto Survey/Graphs/Figure_14.csv")
...
figure_15_data <- fread("C:/Users/alockhart/Desktop/Toronto Survey/Graphs/Figure_15.csv")
